...
const RECORD_EXISTING = '/records/';
const RECORD_VIEW = '/view-record/';
const RECORD_CREATE = '/new/';
const RECORD_RECORD = '/record/';
const REVISION = '/revision/';
export const ABOUT_BUILD = '/about-build';
export const OFFLINE_MAPS = '/offline-maps';
const AUTOINCREMENT = '/autoincrements/';
const PROJECT_ATTACHMENT = '/attachment/';
const SWITCH_ORG = '/switch-organisation';
const HELP = '/help';
const USER_ACTIVE_TESTR = '/test';
